...
Revision ID: db6ec8c3af69
Revises: 5ad9ce31c7ed
Create Date: 2023-08-02 01:57:46.694578
...
revision = 'db6ec8c3af69'
down_revision = '5ad9ce31c7ed'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'order_detail', 'option', ['option_pk'], ['option_pk'], source_schema='kiosk', referent_schema='kiosk')
...
def downgrade() -> None:
    ...
    op.create_foreign_key('order_detail_ibfk_1', 'order_detail', 'option', ['option_pk'], ['option_pk'])
