...
Revision ID: d905197a03c3
Revises: 467690dce96c
Create Date: 2023-08-01 23:24:24.178322
...
revision = 'd905197a03c3'
down_revision = '467690dce96c'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('order_detail', sa.Column('options_pk', mysql.INTEGER(), autoincrement=False, nullable=True))
    op.drop_constraint(None, 'order_detail', schema='kiosk', type_='foreignkey')
    op.drop_constraint(None, 'order_detail', schema='kiosk', type_='foreignkey')
    op.create_foreign_key('order_detail_ibfk_3', 'order_detail', 'menu', ['menu_pk'], ['menu_pk'])
    op.create_foreign_key('order_detail_ibfk_1', 'order_detail', 'option', ['options_pk'], ['option_pk'])
