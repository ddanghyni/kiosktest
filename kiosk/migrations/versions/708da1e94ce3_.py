...
Revision ID: 708da1e94ce3
Revises: 0332e74238cd
Create Date: 2023-08-02 01:14:32.355251
...
revision = '708da1e94ce3'
down_revision = '0332e74238cd'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.add_column('order_detail', sa.Column('option_pk', sa.Integer(), nullable=True))
